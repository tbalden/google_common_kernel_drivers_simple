...
DEFINE_MALI_ADD_EVENT(TILER_CHUNK_ALLOC);
DEFINE_MALI_ADD_EVENT(TILER_CHUNK_ALLOC_SIZE);
DEFINE_MALI_ADD_EVENT(TILER_CHUNK_FREE);
DEFINE_MALI_ADD_EVENT(TILER_CHUNK_FREE_SIZE);
